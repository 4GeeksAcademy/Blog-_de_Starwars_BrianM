            ...
            <div className='row'>
                ...
                <div className='col-lg-6 p-3 text-center d-flex align-items-center flex-column justify-content-center text-white'>
                    ...
                    <p className='text-white-50'>
                        El {vehicleObj.name} (Modelo: {vehicleObj.model}), fabricado por {vehicleObj.manufacturer},
                        es un vehículo de clase {vehicleObj.vehicleClass} esencial para el transporte en la galaxia. 
                        Con una longitud de {vehicleObj.length} metros y una capacidad de carga de {vehicleObj.cargoCapacity}, 
                        está diseñado para ser operado por una tripulación de {vehicleObj.crew}. Ha jugado un papel fundamental en numerosos conflictos,
                        desde el contrabando hasta las grandes batallas espaciales.
                    </p>
                </div>
            </div>
